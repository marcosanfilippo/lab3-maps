...
public class MinPath {
	...
	public BusStop getBusStopSource() {
		//TODO performance killer

		BusStopService busStopService = new BusStopServiceHibernateImpl();
		return busStopService.getBusStop(getIdSource());
	}
	
	public BusStop getBusStopDestination() {
		//TODO performance killer

		BusStopService busStopService = new BusStopServiceHibernateImpl();
		return busStopService.getBusStop(getIdDestination());
	}
}
